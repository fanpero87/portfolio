            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                    <h2
                        ...
                        Whant to get in touch?
                    </h2>
                    <p class="text-body-color mb-9 text-base leading-relaxed dark:text-gray-200">
                        Fell free to send me an email if you want to contact me and talk.
                    </p>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base dark:text-gray-300">fabio@amiscloud.com</p>
                        </div>
                    </div>
                </div>
            </div>
